...
for i in range(0, len(fileName)) :
    fp = open("overhead_test_all/intel_double/" + fileName[i], "r")
    line = fp.readline()
    line = line.split(",")
...
for i in range(0, len(fileName)) :
    fp = open("overhead_test_all/intel_float/" + fileName[i], "r")
    line = fp.readline()
    line = line.split(",")
...
for i in range(0, len(fileName)) :
    fp = open("overhead_test_all/intel_rlibm_generic/" + fileName[i], "r")
    line = fp.readline()
    line = line.split(",")
