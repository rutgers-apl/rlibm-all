...
for i in range(0, 8) :
    fp = open("overhead_test_all/glibc_double/" + fileName[i], "r")
    line = fp.readline()
    line = line.split(",")
...
for i in range(0, 8) :
    fp = open("overhead_test_all/glibc_float/" + fileName[i], "r")
    line = fp.readline()
    line = line.split(",")
...
for i in range(0, 8) :
    fp = open("overhead_test_all/glibc_rlibm_generic/" + fileName[i], "r")
    line = fp.readline()
    line = line.split(",")
